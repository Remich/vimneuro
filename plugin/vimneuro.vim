...
" check user option for 'not using the default mappings'
if exists("g:vimneuro_no_default_mappings") == v:true && g:vimneuro_no_default_mappings == 1
	let g:vimneuro_no_default_mappings = v:true
else
	let g:vimneuro_no_default_mappings = v:false
endif
...
augroup vimneuro
	...
	if g:vimneuro_no_default_mappings == v:false
